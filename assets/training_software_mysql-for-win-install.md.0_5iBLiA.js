import{_ as s,o as a,c as n,U as e}from"./chunks/framework.AM0-35oE.js";const u=JSON.parse('{"title":"Mysql for Windows 安装及初始化","description":"Mysql for Windows 安装及初始化。","frontmatter":{"description":"Mysql for Windows 安装及初始化。","categories":["教程分享"],"tags":["mysql","windows"],"sticky":2},"headers":[],"relativePath":"training/software/mysql-for-win-install.md","filePath":"training/software/mysql-for-win-install.md","lastUpdated":1710488927000}'),p={name:"training/software/mysql-for-win-install.md"},l=e(`<h1 id="mysql-for-windows-安装及初始化" tabindex="-1">Mysql for Windows 安装及初始化 <a class="header-anchor" href="#mysql-for-windows-安装及初始化" aria-label="Permalink to &quot;Mysql for Windows 安装及初始化&quot;">​</a></h1><h2 id="一、简介" tabindex="-1">一、简介 <a class="header-anchor" href="#一、简介" aria-label="Permalink to &quot;一、简介&quot;">​</a></h2><p>Windows 安装 Mysql 主要还是为了本地调试的方便。8.x 的版本和 5.7 的版本安装过程大差不差，这里以 8.0.35（8.2版本发布前的最新版）举例。</p><h2 id="二、下载安装" tabindex="-1">二、下载安装 <a class="header-anchor" href="#二、下载安装" aria-label="Permalink to &quot;二、下载安装&quot;">​</a></h2><p>Windows 端 Mysql 只需要在 <a href="https://dev.mysql.com/downloads/mysql/" target="_blank" rel="noreferrer">MySQL :: Download MySQL Community Server</a> 页面选择对应版本下载 mysql-xxx-winx64.zip，该压缩包为编译后文件，并非源码， 可以直接运行。</p><p>目录结构如下：</p><div class="language-text vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>Directory: D:\\Element\\mysql-8.0.35</span></span>
