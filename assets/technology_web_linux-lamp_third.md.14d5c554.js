import{_ as s,o as a,c as p,Q as l}from"./chunks/framework.5584abd2.js";const u=JSON.parse('{"title":"第三步 编译安装PHP","description":"","frontmatter":{"tags":["Linux","架构","运维","LAMP"],"hidden":true,"category":"Linux 运维"},"headers":[],"relativePath":"technology/web/linux-lamp/third.md","filePath":"technology/web/linux-lamp/third.md","lastUpdated":1697076169000}'),e={name:"technology/web/linux-lamp/third.md"},n=l(`<h1 id="第三步-编译安装php" tabindex="-1">第三步 编译安装PHP <a class="header-anchor" href="#第三步-编译安装php" aria-label="Permalink to &quot;第三步 编译安装PHP&quot;">​</a></h1><h2 id="_1、安装前准备" tabindex="-1">1、安装前准备 <a class="header-anchor" href="#_1、安装前准备" aria-label="Permalink to &quot;1、安装前准备&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">#编译安装libmcrypt</span></span>
