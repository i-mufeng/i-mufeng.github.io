import{c as a,S as n,h as p,l as e}from"./chunks/framework.CuiMOlaJ.js";const u=JSON.parse('{"title":"Linux 磁盘管理 - 记一次分区格式化","description":"通过一次虚拟化平台服务器新加磁盘的操作，讨论 Linux 平台磁盘管理、分区格式化的操作。","frontmatter":{"title":"Linux 磁盘管理 - 记一次分区格式化","description":"通过一次虚拟化平台服务器新加磁盘的操作，讨论 Linux 平台磁盘管理、分区格式化的操作。","categories":["折腾日记"],"tags":["Linux","运维","磁盘管理"],"outline":[2,3],"date":"2025-04-25T00:00:00.000Z","cover":"https://cdn.imufeng.cn/mblog/2025/disk-management.png","head":[["meta",{"name":"keywords","content":"Linux, 运维, fdisk, parted, 磁盘管理, 磁盘工具, 分区格式化"}]]},"headers":[],"relativePath":"training/linux/disk-management.md","filePath":"training/linux/disk-management.md","lastUpdated":1778807387000}'),i={name:"training/linux/disk-management.md"};function l(t,s,c,d,o,r){return n(),p("div",{"data-pagefind-body":!0,"data-pagefind-meta":"date:1745539200000"},[...s[0]||(s[0]=[e(`<h1 id="linux-磁盘管理-记一次分区格式化" tabindex="-1">Linux 磁盘管理 - 记一次分区格式化 <a class="header-anchor" href="#linux-磁盘管理-记一次分区格式化" aria-label="Permalink to &quot;Linux 磁盘管理 - 记一次分区格式化&quot;">​</a></h1><blockquote><p>注意：</p><ul><li>数据无价，谨慎操作！！！</li><li>具体业务敏感部分已做脱敏处理，示例服务器域为 <code>mufeng.dev</code></li></ul></blockquote><p>我们有个业务项目使用华为 <strong>FusionCompute</strong> 搭建了一套私有云平台，属于比较高的配置，该教程记录一次操作系统加磁盘后进行分区格式化的操作。</p><ul><li>虚拟化平台：华为 Fusion Compute</li><li>操作系统版本：AlmaLinux 9.5</li></ul><h2 id="一、准备工作" tabindex="-1">一、准备工作 <a class="header-anchor" href="#一、准备工作" aria-label="Permalink to &quot;一、准备工作&quot;">​</a></h2><h3 id="_1-1-简介" tabindex="-1">1.1 简介 <a class="header-anchor" href="#_1-1-简介" aria-label="Permalink to &quot;1.1 简介&quot;">​</a></h3><p>平台图形化界面新增磁盘，此处不再赘述，新增后进入系统，查看属性如下：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>[root@mufeng /]# df -h</span></span>
