import{_ as s,o as a,c as n,Q as e}from"./chunks/framework.6a38f59a.js";const g=JSON.parse('{"title":"第一步 编译安装httpd服务器","description":"","frontmatter":{"tags":["Linux","架构","运维","LAMP"],"hidden":true,"category":"Linux 运维"},"headers":[],"relativePath":"technology/web/linux-lamp/first.md","filePath":"technology/web/linux-lamp/first.md","lastUpdated":1697020922000}'),p={name:"technology/web/linux-lamp/first.md"},l=e(`<h1 id="第一步-编译安装httpd服务器" tabindex="-1">第一步 编译安装httpd服务器 <a class="header-anchor" href="#第一步-编译安装httpd服务器" aria-label="Permalink to &quot;第一步 编译安装httpd服务器&quot;">​</a></h1><h2 id="_1、安装前准备" tabindex="-1">1、安装前准备 <a class="header-anchor" href="#_1、安装前准备" aria-label="Permalink to &quot;1、安装前准备&quot;">​</a></h2><p>解压apr apr-util pcre httpd expat包</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@localhost app]# tar -xvf apr-1.6.5.tar.xz -C /app/</span></span>
