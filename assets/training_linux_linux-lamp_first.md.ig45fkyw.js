import{_ as s,c as n,o as p,a6 as e}from"./chunks/framework.DwkvEpDD.js";const u=JSON.parse('{"title":"第一步 编译安装httpd服务器","description":"","frontmatter":{"tags":["Linux","架构","运维","LAMP"],"hidden":true,"category":"Linux 运维"},"headers":[],"relativePath":"training/linux/linux-lamp/first.md","filePath":"training/linux/linux-lamp/first.md","lastUpdated":1710488927000}'),t={name:"training/linux/linux-lamp/first.md"};function l(o,a,c,i,r,h){return p(),n("div",{"data-pagefind-body":!0},a[0]||(a[0]=[e(`<h1 id="第一步-编译安装httpd服务器" tabindex="-1">第一步 编译安装httpd服务器 <a class="header-anchor" href="#第一步-编译安装httpd服务器" aria-label="Permalink to &quot;第一步 编译安装httpd服务器&quot;">​</a></h1><h2 id="_1、安装前准备" tabindex="-1">1、安装前准备 <a class="header-anchor" href="#_1、安装前准备" aria-label="Permalink to &quot;1、安装前准备&quot;">​</a></h2><p>解压apr apr-util pcre httpd expat包</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>[root@localhost app]# tar -xvf apr-1.6.5.tar.xz -C /app/</span></span>
